...
% ---------- Section heading with right-aligned italic annotation ----------
% \propsection{number}{Title}{annotation}
\newcommand{\propsection}[3]{%
  \vspace{8pt}%
  \noindent{\Large\bfseries #1.\ #2}\hfill{\itshape #3}\par
  \vspace{2pt}%
}
% Section heading with no annotation
...
% ================= 1. Higher-order goal =================
\propsection{1}{Higher-order goal}{...secondary framing}
...
% ================= 2. Time-to-value =================
\propsection{2}{Time-to-value}{...primary heuristic}
...
% ================= 5. Solution Approach =================
\propsection{5}{Solution Approach}{...engineering focus}
...
\propsection{6}{Evaluation Criterion}{...measurable and attributable}
...
% ================= 7. Scalability =================
\propsection{7}{Scalability}{...with foresight}
